...
def get_subject_links(driver):
    ...
    xpath_bindo = '//*[@id="subject-area"]/div[2]/div[2]/div/a/div'
    driver.find_element_by_xpath(xpath_bindo).click()
    # ambil mapel
    ...
    for q in range(50):
        ...
        db.insert_url('bahasa_indonesia', href)
        sleep(3)
...
if __name__ == '__main__':    
    ...
    # driver.close()
    data = db.get_all_urls('bahasa_indonesia')
    for url in data:
        try:
            u = url['url']
            value = db.check_docs('info', u)
            if value is False:
